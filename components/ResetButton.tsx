...
export default function ResetButton(props: ButtonProps){
    ...
    const HandleResetButton = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    <div  onClick={HandleResetButton} >
        <svg className="button" id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211.86 112.46">
            ...
            <text transform="translate(5.57 103.79)" fill="#dfdfdf" font-family="Futura-75Bold, Futura" font-size="34.68" font-weight="700">
                <tspan x="0" y="0" letter-spacing=".03em">R</tspan><tspan x="22.81" y="0" letter-spacing=".03em">E</tspan>
                <tspan x="40.82" y="0" letter-spacing="0em">P</tspan>
                <tspan x="61.31" y="0" letter-spacing=".03em">AIR </tspan>
                <tspan x="131.37" y="0" letter-spacing=".04em">C</tspan>
                <tspan x="153.32" y="0" letter-spacing=".03em">AR</tspan>
            </text>
